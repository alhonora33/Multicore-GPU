...
# Paramètres à varier
ARRAY_LENS=(1024 2048 4096 8182 16364 32728 66456 132912 263824 527648 1055296 2110592 4221184 8442368 16884736 33769472 67538944 135077888 270155776 540311552 1080623104 2161246208) # Valeurs pour --array-len
  NB_BINS_LIST=(32 512 2048 4096)         # Valeurs pour --nb-bins
    NB_REPEAT=20                  # Fixe
    LOWER_BOUND=0                   # Fixe
    UPPER_BOUND=10                  # Fixe
